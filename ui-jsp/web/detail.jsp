...
<%@ page import="org.dandoy.bug4j.server.gwt.client.data.BugDetail" %>
...
<div id="wrapper">
    <div id="content">
        <div id="incontent">
            <div id="crumbs"><a href="/">Top Bugs</a> > bug<%=bugDetail.getId()%>
            </div>
            <H1>
                <%=bugDetail.getId()%>-<%=Util.encode(bugDetail.getTitle())%>
            </H1>

            <div id="bug-msg"><%=bugDetail.getMessage()%>
            </div>
            <div id="bug-exmsg"><%=bugDetail.getExceptionMessage()%>
            </div>
            <div id="bug-stack"><%=bugDetail.getStackText()%>
            </div>
        </div>
    </div>
</div>
