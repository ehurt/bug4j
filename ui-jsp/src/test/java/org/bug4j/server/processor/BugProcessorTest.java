...
public class BugProcessorTest {
    ...
    public void testDedupeByTitle_1() throws Exception {
        ...
        final long bug_0 = BugProcessor.process(_store, null, APP, APP_VERSION, null, dateReported, null, "" +
        ...
        final long bug_1 = BugProcessor.process(_store, null, APP, APP_VERSION, null, dateReported, null, "" +
                "java.lang.IllegalStateException: oh oh!\n" +
                "\tat org.bug4j.SomeClass.someMethod(SomeClass.java:100)\n" +
        ...
        final long bug_2 = BugProcessor.process(_store, null, APP, APP_VERSION, null, dateReported, null, "" +
                "java.lang.IllegalStateException: oh oh!\n" +
                "\tat org.bug4j.SomeClass.someMethod(SomeClass.java:100)\n" +
                "\tat org.bug4j.SomeClass.someOtherMethod(SomeClass.java:500)\n" +
